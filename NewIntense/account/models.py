...
class Candidate(models.Model):
    ...
    Criticality = models.CharField(choices=GND_CHOICES, max_length=128,null=True)
    Requirements =models.CharField(choices=GND_CHOICES, max_length=128,null=True)
    Description=models.CharField(choices=GND_CHOICES, max_length=128,null=True)
    ...
    Additional_info= models.CharField(max_length = 50,default='Not Applicable')
