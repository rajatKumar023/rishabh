...
class candidateRegForm(UserCreationForm):
    ...
    Criticality = forms.ChoiceField(choices=GND_CHOICES, widget=forms.RadioSelect())
    Requirements = forms.ChoiceField(choices=REQ_CHOICES, widget=forms.RadioSelect())
    Description = forms.ChoiceField(choices=DES_CHOICES, widget=forms.RadioSelect())
    ...
    Additional_info = forms.CharField(required =False,validators=[RegexValidator(r'[a-zA-Z]+', 'Only  characters.')])
    ...
    def save(self):
        ...
        candidate.Criticality=self.cleaned_data.get('Criticality')
        candidate.Requirements=self.cleaned_data.get('Requirements')
        candidate.Description=self.cleaned_data.get('Description')
        ...
        candidate.Additional_info=self.cleaned_data.get('Additional_info')
